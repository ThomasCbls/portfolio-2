...
//       },
//       {
//         icon: <CurlyBracesIcon width={20} height={20} />,
//         content:
...
//     steps: [
//       {
//         icon: <ClosedCaptionIcon width={20} height={20} />,
...
//       },
//       {
//         icon: <GeorgianLariIcon width={20} height={20} />,
//         content:
...
//       },
//       {
//         icon: <LucideCloudLightning width={20} height={20} />,
//         content:
...
//     steps: [
//       {
//         icon: <ListStartIcon width={20} height={20} />,
//         content:
//           "Rolled out AI-driven marketplace for personalized product discovery.",
//       },
//       {
//         icon: <MagnetIcon width={20} height={20} />,
